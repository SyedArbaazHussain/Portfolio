...
const Projects: React.FC = () => {
  ...
  const handlePrevious = () => {
    ...
    return (
      <div className="flex w-full justify-center flex-col text-center overflow-hidden px-5 sm:px-20 md:px-0">
        {/* Mobile Grid View */}
        <div className="md:hidden flex flex-col items-center justify-center h-full w-full px-6">
        <h1 className="text-3xl sm:text-4xl lg:font-black font-bold text-center text-gray-800 dark:text-gray-200">
          Projects
          </h1>
        ...
        <div className="hidden lg:flex flex-col items-center justify-center w-full px-10">
          ...
          <div className="grid grid-cols-12 gap-5 -mx-60 xl:mx-auto justify-center items-center">
            {/* Previous Project */}
            <div
