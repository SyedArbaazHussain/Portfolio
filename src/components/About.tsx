...
const About: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen pt-40 px-3 sm:px-10 md:px-16 lg:px-32 xl:px-60 w-full justify-center flex-col text-center overflow-hidden">
      {/* Heading */}
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-center text-gray-800 dark:text-gray-200">
        About
      </h1>
      <h2 className="font-semibold text-orange-600 opacity-90 dark:text-orange-400 mb-6 lg:text-3xl text-lg sm:text-xl md:text-2xl">
